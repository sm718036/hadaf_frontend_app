...
const applicationSchema = z.object({
  ...
  partnerUniversityId: z.string().uuid().nullable(),
  partnerUniversityName: z.string().nullable(),
  partnerCampusId: z.string().uuid().nullable(),
  partnerCampusName: z.string().nullable(),
  partnerCourseId: z.string().uuid().nullable(),
  partnerCourseName: z.string().nullable(),
  academicStage: z.enum(["applied", "interview", "offer", "cas_coe"]),
  enrollmentStatus: z.enum(["not_enrolled", "enrolled"]),
...
const upsertApplicationSchema = z.object({
  ...
  partnerUniversityId: z.string().uuid().nullable().optional(),
  partnerCampusId: z.string().uuid().nullable().optional(),
  partnerCourseId: z.string().uuid().nullable().optional(),
  academicStage: z.enum(["applied", "interview", "offer", "cas_coe"]),
  enrollmentStatus: z.enum(["not_enrolled", "enrolled"]),
