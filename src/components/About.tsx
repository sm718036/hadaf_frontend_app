...
export function About() {
  ...
  return (
    <section id="about" className="bg-white px-4 py-20 sm:px-6 sm:py-24 lg:px-8 lg:py-32">
      <div className="site-shell">
        <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-stretch lg:gap-14">
          <Reveal className="about-stat-frame relative mx-auto flex min-h-[280px] w-full max-w-md overflow-hidden bg-brand-soft px-6 py-6 sm:min-h-[360px] sm:px-8 sm:py-8 lg:mx-0 lg:max-w-none">
          ...
          <Reveal
            className="flex h-full flex-col justify-center text-center lg:text-left"
            delay={120}
          >
            <p className="section-label mb-4 justify-center lg:justify-start">{content.eyebrow}</p>

            <h2 className="max-w-2xl text-[clamp(2rem,7vw,3rem)] font-extrabold leading-[1.15] text-foreground">
              ...
              <Reveal key={feature.title} delay={index * 100}>
                <article className="about-feature-card relative h-full overflow-hidden bg-white px-6 py-6 shadow-[0_10px_28px_rgba(11,20,37,0.12)] before:hidden after:hidden">
                  <div className="flex items-start gap-4">
                    <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-primary text-dark sm:h-[72px] sm:w-[72px]">
